...
def mainGame():
    ...
    while True:
        ...
        # This function will return true if the player is crash
        ...
        for pipe in upperPipes:
            pipeModPos = pipe['x'] + GAME_SPRITES['pipe'][0].get_width()/2
            if pipeModPos <= playerMidPos < pipeModPos + 4:
                score += 1
...
def getRandomPipe():
    """
    generate positions of two pipes(One bottom straight and one top rated) for blitting on the screen
    """
    pipeHeight = GAME_SPRITES['pipe'][0].get_height()
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Fahad')
